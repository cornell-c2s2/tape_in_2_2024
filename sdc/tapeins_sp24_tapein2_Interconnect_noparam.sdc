...
# Mon Jun  3 02:15:40 2024
###############################################################################
current_design tapeins_sp24_tapein2_Interconnect_noparam
###############################################################################
# Timing Constraints
###############################################################################
...
# Environment
###############################################################################
set_load -pin_load 0.1900 [get_ports {adapter_parity}]
set_load -pin_load 0.1900 [get_ports {minion_parity}]
set_load -pin_load 0.1900 [get_ports {miso}]
set_load -pin_load 0.1900 [get_ports {vccd1}]
set_load -pin_load 0.1900 [get_ports {vssd1}]
